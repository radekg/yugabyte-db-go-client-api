package snapshotslistrestorations
...
var Command = &cobra.Command{
	Use:   "list-snapshot-restorations",
	Short: "List snapshot restorations",
	Run:   run,
	Long:  ``,
}
...
var (
	...
	opConfig      = configs.NewOpSnapshotListRestorationsConfig()
)
...
func processCommand() int {
	...
	logger := logConfig.NewLogger("list-snapshot-restorations")
	...
	responsePayload, err := cliClient.SnapshotsListRestorations(opConfig)
	if err != nil {
		logger.Error("failed listing snapshot restorations", "reason", err)
		return 1
	}
