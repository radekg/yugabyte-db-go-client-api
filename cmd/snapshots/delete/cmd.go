...
var (
	...
	opConfig      = configs.NewOpSnapshotDeleteConfig()
)
...
func processCommand() int {
	...
	logger := logConfig.NewLogger("delete-snapshot")
	...
	responsePayload, err := rpcAPI.SnapshotsDelete(opConfig)
	if err != nil {
		logger.Error("failed deleting snapshot", "reason", err)
		return 1
	}
