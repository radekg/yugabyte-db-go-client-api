...
var (
	...
	opConfig      = configs.NewOpSnapshotCreateConfig()
)
...
func processCommand() int {
	...
	logger := logConfig.NewLogger("create-snapshot")
	...
	responsePayload, err := rpcAPI.SnapshotsCreate(opConfig)
	if err != nil {
		logger.Error("failed creating snapshot", "reason", err)
		return 1
	}
