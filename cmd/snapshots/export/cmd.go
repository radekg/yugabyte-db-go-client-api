...
var (
	...
	opConfig      = configs.NewOpSnapshotExportConfig()
)
...
func processCommand() int {
	...
	responsePayload, err := rpcAPI.SnapshotsExport(opConfig)
	if err != nil {
		logger.Error("failed exporting snapshot", "reason", err)
		return 1
	}
